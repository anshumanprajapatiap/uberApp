...
(7, 4.4, true, ST_GeomFromText('POINT(77.2800 28.5900)', 4326), 'MH06KL1234'),
(8, 4.5, true, ST_GeomFromText('POINT(77.2600 28.6800)', 4326), 'GJ07MN5678'),
(9, 4.6, true, ST_GeomFromText('POINT(77.2200 28.6400)', 4326), 'KA08OP9012'),
(10, 4.7, true, ST_GeomFromText('POINT(77.2700 28.6700)', 4326), 'TN09QR3456'),
(11, 4.8, true, ST_GeomFromText('POINT(77.2400 28.6100)', 4326), 'AP10ST7890'),
(12, 4.2, true, ST_GeomFromText('POINT(77.2300 28.6600)', 4326), 'TS11UV1234'),
(13, 4.1, true, ST_GeomFromText('POINT(77.1900 28.6000)', 4326), 'KL12WX5678'),
(14, 4.0, true, ST_GeomFromText('POINT(77.1800 28.6300)', 4326), 'WB13YZ9012'),
(15, 4.5, true, ST_GeomFromText('POINT(77.1500 28.6500)', 4326), 'MP14AB3456'),
(16, 4.3, true, ST_GeomFromText('POINT(77.1200 28.6700)', 4326), 'BR15CD7890'),
(17, 4.6, true, ST_GeomFromText('POINT(77.1700 28.6800)', 4326), 'OR16EF1234'),
(18, 4.4, true, ST_GeomFromText('POINT(77.1400 28.6900)', 4326), 'AS17GH5678'),
(19, 4.7, true, ST_GeomFromText('POINT(77.1300 28.7000)', 4326), 'CH18IJ9012'),
(20, 4.8, true, ST_GeomFromText('POINT(77.1100 28.7100)', 4326), 'UA19KL3456'),
(21, 4.5, true, ST_GeomFromText('POINT(77.2295 28.6129)', 4326), 'HR20MN7890'),
(22, 4.7, true, ST_GeomFromText('POINT(77.2285 28.6159)', 4326), 'DL21OP1234'),
(23, 4.8, true, ST_GeomFromText('POINT(77.2315 28.6119)', 4326), 'UP22QR5678'),
(24, 4.6, true, ST_GeomFromText('POINT(77.2325 28.6169)', 4326), 'PB23ST9012'),
(25, 4.9, true, ST_GeomFromText('POINT(77.2345 28.6179)', 4326), 'RJ24UV3456'),
(26, 4.3, true, ST_GeomFromText('POINT(77.2355 28.6199)', 4326), 'MH25WX7890'),
(27, 4.4, true, ST_GeomFromText('POINT(77.2365 28.6219)', 4326), 'GJ26YZ1234'),
(28, 4.5, true, ST_GeomFromText('POINT(77.2375 28.6239)', 4326), 'KA27AB5678'),
(29, 4.6, true, ST_GeomFromText('POINT(77.2385 28.6259)', 4326), 'TN28CD9012'),
(30, 4.7, true, ST_GeomFromText('POINT(77.2395 28.6279)', 4326), 'AP29EF3456'),
(31, 4.8, true, ST_GeomFromText('POINT(77.2405 28.6299)', 4326), 'TS30GH7890'),
(32, 4.2, true, ST_GeomFromText('POINT(77.2415 28.6319)', 4326), 'KL31IJ1234'),
(33, 4.1, true, ST_GeomFromText('POINT(77.2425 28.6339)', 4326), 'WB32KL5678'),
(34, 4.0, true, ST_GeomFromText('POINT(77.2435 28.6359)', 4326), 'MP33MN9012'),
(35, 4.5, true, ST_GeomFromText('POINT(77.2445 28.6379)', 4326), 'BR34OP3456'),
(36, 4.3, true, ST_GeomFromText('POINT(77.2455 28.6399)', 4326), 'OR35QR7890'),
